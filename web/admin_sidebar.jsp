...
<nav id="sidebar">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link<%= (request.getRequestURI().endsWith("CustomersServlet")) ? " active" : "" %>" href="CustomersServlet">
                普通用户
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link<%= (request.getRequestURI().endsWith("AdminsServlet")) ? " active" : "" %>" href="AdminsServlet">
                管理员用户
            </a>
        </li>
        <li class="nav-item">
